...
//     associativeRequests
//         .add({'studentRef': studentRef.path, 'type': type, 'details': ''});
//     notifyListeners();
//   }
...
//   Future<void> notifyStudent(DocumentReference studentRef,
//       DocumentReference requestRef, String message) async {
//     try {
...
//           .map((doc) => AddRequestModel.fromFirestore(doc))
//           .toList();
//     } catch (e) {
...
//   Future<List<RequestModel>> fetchDeleteRequests(
