...
class ChangeSectionPage extends StatefulWidget {
  static const String screenRoute = 'change_section_screen';
  ...
  @override
  _ChangeSectionPageState createState() => _ChangeSectionPageState();
}

class _ChangeSectionPageState extends State<ChangeSectionPage> {
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        '1- ما المقرر الذي تود تعديل شعبته ؟',
                        style: TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.bold,
                        ),
                      ...
                      const Text(
                        '2- اختر الشعبة المراد التحويل لها',
                        style: TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.bold,
                        ),
