...
class _StudentHomePageState extends State<StudentHomePage> {
  ...
  Future<StudentModel?> fetchStudentData() async {
    try {
      // البحث عن بيانات الطالب باستخدام البريد الإلكتروني
  ...
  Future<String?> fetchAdvisorName() async {
    try {
      // جلب بيانات الطالب للحصول على الحقل advisorID كـ Reference
      ...
      final advisorRef = studentData['advisorID'] as DocumentReference; // استخدام الحقل Reference
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/icons/stHome.png'), // صورة الخلفية
            fit: BoxFit.cover,
          ),
        ),
        child: FutureBuilder<StudentModel?>(
          ...
          builder: (context, studentSnapshot) {
            if (studentSnapshot.connectionState == ConnectionState.waiting) {
              ...
              return Center(child: Text('خطأ أثناء تحميل بيانات الطالب.'));
            } else if (studentSnapshot.data == null) {
              return Center(child: Text('تعذر العثور على بيانات الطالب.'));
            }
            ...
            return FutureBuilder<String?>(
              ...
              builder: (context, advisorSnapshot) {
                if (advisorSnapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Center(child: Text('خطأ أثناء تحميل بيانات المرشد.'));
                }
